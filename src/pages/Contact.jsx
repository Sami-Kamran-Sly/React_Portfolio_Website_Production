...
<section className="text-white body-font relative">
  ...
  <div className="  flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe width="100%" height="100%" className="absolute inset-0 " loading='lazy' frameBorder={0} title="map" marginHeight={0} marginWidth={0} scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=%C4%B0zmir+(My%20Business%20Name)&ie=UTF8&t=&z=14&iwloc=B&output=embed" style={{filter: 'grayscale(1) contrast(1.2) opacity(0.4)'}} />




      <div className=" bg-[linear-gradient(90deg,_rgba(25,25,27,1)_10%,_rgba(33,33,35,1)_100%)] relative flex flex-wrap py-6 rounded shadow-md">
    ...
    <div className="lg:w-1/3 md:w-1/2 sm:px-5  w px-6 bg-[linear-gradient(90deg,_rgba(25,25,27,1)_20%,_rgba(37,37,38,1)_100%)] flex flex-col md:ml-auto  w-auto   md:py-8 mt-8 md:mt-0">
      <h2 className=" text-indigo-500 text-lg mb-1 font-medium title-font">Feedback</h2>
      ...
      <div className="relative mb-4 ">
        ...
        <input type="text" id="name" name="name" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
      </div>
      <div className="relative mb-4 ">
      ...
      <p className="text-xs text-white mt-3 mb-4">Chicharrones blog helvetica normcore iceland tousled brook viral artisan.</p>
    </div>
  </div>
  </BaseContainerBox>
...
export default transitonsPage( Contact);
